  ...
  return (
    <>
      <div className="flex items-center justify-between z-10">
        <div className="text-2xl flex items-center justify-center font-medium w-[100px] h-[100px] rounded-full text-white bg-[#4a3ef2be]">
      ...
      <NavLink className={({isActive})=>clsx({'bg-[#d92732] text-white   ': isActive},"text-2xl font-semibold rounded hover:text-white  hover:bg-[#d92732] p-2",{"text-[#d92732]":!isActive})  } to="/" onClick={()=>context.setIsOpen(true)}>Html Quiz</NavLink> */}
        ...
        <button
          ...
          className="bg-[#4a3ef2be] text-white px-5 py-2 rounded text-lg font-medium"
        >
          Log In
        </button>
      </div>
